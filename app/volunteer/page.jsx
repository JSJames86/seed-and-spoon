export const metadata = {
  title: "Volunteer with Seed & Spoon | Join Our Food Justice Mission",
  description:
    "Volunteer with Seed & Spoon to help rescue surplus food, prepare meals, and serve families facing hunger. Flexible shifts, meaningful impact, and community connection await.",
  openGraph: {
    title: "Volunteer | Seed & Spoon - Make a Difference",
    description:
