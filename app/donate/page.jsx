export const metadata = {
  title: "Donate to Seed & Spoon | Support Hunger Relief & Food Justice",
  description:
    "Your donation helps Seed & Spoon rescue surplus food, prepare fresh meals, and empower families across New Jersey. Every dollar fights hunger and reduces waste.",
  openGraph: {
    title: "Donate | Seed & Spoon - Every Dollar Feeds Families",
    description:
