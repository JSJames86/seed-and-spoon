        ...
        <section className="bg-gradient-to-br from-green-700 to-green-900 py-20 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center mb-12">
              <Link href="/get-help" className="rounded-lg bg-green-600 px-8 py-4 font-bold text-white transition hover:bg-green-500 shadow-lg hover:shadow-xl text-center">
                Get Help
              </Link>
              <Link href="/donate" className="rounded-lg bg-orange-600 px-8 py-4 font-bold text-white transition hover:bg-orange-500 shadow-lg hover:shadow-xl text-center">
                Donate Now
              </Link>
              <Link href="/volunteer" className="rounded-lg border-2 border-white px-8 py-4 font-bold text-white transition hover:bg-white hover:text-green-900 shadow-lg hover:shadow-xl text-center">
                Volunteer
              </Link>
            </div>
