 ...
 *   (the top BEAM_WIDTH-1 recipes by marginal score against the starting
 *   pantry, each pinned first via planBuyList's `pinnedRecipe`). Duplicate
 *   resulting plans (same recipe set) are collapsed.
 *
...
export async function buildCoveragePlans({
  ...
  // Anchor recipes: rank by marginal score against a flat cost of 1 (i.e.
