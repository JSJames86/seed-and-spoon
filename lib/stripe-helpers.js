      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              name: 'Monthly Donation to Seed & Spoon',
            },
          },
          quantity: 1,
        },
...
export function getDonationUrls() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || process.env.PUBLIC_BASE_URL || 'http://localhost:3000';
