      ...
      <Body style={body}>
        ...
        <Container style={container}>
          ...
          <Section style={dataTable}>
            ...
            {receiptId && <Row label="Receipt No." value={receiptId} mono />}
...
const orgLine: React.CSSProperties = { color: MUTED, fontSize: '12px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif', margin: '12px 0 4px 0' }
const boldNote: React.CSSProperties = { color: DARK_TEXT, fontSize: '13px', fontWeight: 'bold', lineHeight: '1.6', margin: '0 0 12px 0' }
